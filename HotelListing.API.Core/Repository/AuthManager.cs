...
namespace HotelListing.API.Core.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        {
            _logger.LogInformation($"Looking for user with email {loginDTO.Email} started at {DateTime.UtcNow}");
            bool isValid = false;
            ...
            {
                _logger.LogWarning($"User with email {loginDTO.Email} was not found in the database.");
                return null;
            }
